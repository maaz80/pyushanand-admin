      ...
      <div className="bg-[#0b1326] p-6 rounded-2xl border border-slate-800 shadow-md space-y-6">
        ...
        {companies.length === 0 ? (
          <div className="p-8 text-center bg-[#121c33] rounded-2xl border border-dashed border-slate-700">
            <p className="text-sm font-semibold text-slate-300">No company logos found</p>
            <p className="text-xs text-slate-400 mt-1">Click "Add Company Logo" to upload your first brand logo.</p>
          </div>
        ) : (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {companies.map((comp, idx) => (
              <div
                key={comp._id || idx}
                className="bg-[#121c33] border border-slate-800 rounded-2xl p-4 flex flex-col items-center justify-between space-y-3 relative group shadow-md"
              >
                {/* Dark Preview Tile so white/light SVG/PNG logos are visible */}
                <div className="w-full h-24 flex items-center justify-center p-2 rounded-xl bg-[#0b1326]">
                  {comp.image ? (
                    <img
                      src={comp.image}
                ...
                <div className="w-full pt-2 border-t border-slate-800 flex items-center justify-between text-xs">
                  <span className="font-medium text-slate-300 truncate max-w-[100px]" title={comp.name}>
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    <button
                      ...
                      className="p-1 rounded bg-[#0b1326] border border-slate-700 text-slate-300 hover:text-white hover:border-primary cursor-pointer"
                      title="Edit Logo"
                    >
                    ...
                    <button
                      ...
                      className="p-1 rounded bg-[#0b1326] border border-slate-700 text-slate-400 hover:text-red-400 hover:border-red-500/30 cursor-pointer"
                      title="Delete Logo"
                    >
