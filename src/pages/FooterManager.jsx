        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#0b1326] p-6 rounded-2xl border border-slate-800 shadow-md space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">Footer Logo Upload</label>
                <ImageUploader setImage={setLogoFile} initialImage={formData.logoUrl} />
              </div>
              <div className="space-y-3">
                <div>
                  <label className="block text-xs font-semibold text-slate-300 mb-1">Logo URL / Path</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-300 mb-1">Hire Me Badge Pill Text</label>
                  <input
                    type="text"
          ...
          <div className="bg-[#0b1326] p-6 rounded-2xl border border-slate-800 shadow-md space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">Download Resume Link Text</label>
                <input
                  type="text"
          ...
          <div className="bg-[#0b1326] p-6 rounded-2xl border border-slate-800 shadow-md space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">Behance Profile URL</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">Dribbble Profile URL</label>
                <input
                  type="text"
          ...
          <div className="bg-[#0b1326] p-6 rounded-2xl border border-slate-800 shadow-md space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <input
                ...
                className="px-3 py-2 text-xs rounded-xl border border-slate-700/70 bg-[#121c33] text-white placeholder-slate-500 focus:bg-[#16233f] focus:border-primary focus:outline-none"
              />
              <input
                type="text"
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-primary text-white text-xs font-semibold rounded-xl flex items-center gap-1 hover:bg-primary-hover cursor-pointer shadow-sm"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {formData.quickLinks.map((ql, idx) => (
                <div
                  key={idx}
                  className="p-3 bg-[#121c33] border border-slate-800 rounded-xl flex items-center justify-between gap-3 text-xs"
                >
                  <div className="space-y-0.5 truncate">
                    <span className="text-[10px] text-slate-400 font-semibold uppercase block">
                      {ql.category || "Case Study"}
                    </span>
                    <p className="font-bold text-white truncate">{ql.title}</p>
                    <p className="text-slate-400 text-[11px] truncate">{ql.link}</p>
                  </div>
                  <button
                    type="button"
